    ...
    <section class="container row">
        <?php
            ...
            for ($i=0; $i < count($pratos); $i++) { 
                echo '<a class="item" href="detalhe-prato.php?id='.$pratos[$i]["id"].'"><div style="cursor: pointer;"><h2 style="color: orange;">'.$pratos[$i]['nome_comida'].'</h2><img class="image contraste" src="admin/img/'.$pratos[$i]['image'].'" height="300"><h3 style="color: white;max-width: 35%;display: inline;">R$'.$pratos[$i]['preco_comida'].'</h3></div></a>';
            }
        ?>
